...
// import {double,times100,myMap} from "..fuExps.js";
import { double,times100,myMap } from "../src/fuExps.js";
...
describe("times100", function () {
    ...
    describe("myMap", function () {
        ...
        it("tests myMap on triples arrow function", function () {
            assert.deepStrictEqual(myMap(testArray,(num:number)=>num*3), [-30, 0, 30, 60]);
        });
    });
