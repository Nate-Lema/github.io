...
// });
import { Player, player3,teamStats } from "../src/playerPoints.js";//teamStats, findTotalScores, findTotalPlayerPoints, findTotalPointsByJersey
...
function concat<T>(arr: T[], arr2: T[]): T[] {
...
function findProduct(...num1: number[]): number {
